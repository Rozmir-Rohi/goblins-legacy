...
public class EntityLightball extends Entity implements IGoblinEntityTextureBase {
	...
	public EntityLightball(World world, double d, double d1, double d2)
	{
		super(world);
		xTile = -1;
		yTile = -1;
	...
	public EntityLightball(World world, EntityLivingBase entityLiving, float f)
	{
		super(world);
		xTile = -1;
		yTile = -1;
		...
		ticksInAir = 0;
		field_35140_d = false;
		shootingEntity = (Entity) entityLiving;
