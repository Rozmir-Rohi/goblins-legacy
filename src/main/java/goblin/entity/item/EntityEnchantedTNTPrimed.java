...
public class EntityEnchantedTNTPrimed extends EntityTNTPrimed implements IEntityAdditionalSpawnData{
	...
	public EntityEnchantedTNTPrimed(World world)
	{
		super(world);
	}
	
	public EntityEnchantedTNTPrimed(World world, double xCoord, double yCoord_, double zCoord, EntityLivingBase entityLivingBase)
    {
