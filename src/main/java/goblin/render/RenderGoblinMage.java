...
public class RenderGoblinMage extends RenderLiving {
	...
	private static ResourceLocation enderDragonCrystalBeamTextures;
	protected ModelGoblinMage modelBipedMain;
	...
	protected void renderCarrying(EntityGoblinMage entityLiving, float par2)
	{
		float f1 = 1.0f;
	...
	static
	{
		texture = new ResourceLocation("goblin:textures/entity/GoblinShaman.png");
