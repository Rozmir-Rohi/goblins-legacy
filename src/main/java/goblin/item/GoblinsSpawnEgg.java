...
public class GoblinsSpawnEgg extends ItemMonsterPlacer {
	
	private IIcon theIcon;

	public GoblinsSpawnEgg()
    {
    ...
    {
        EntityList.EntityEggInfo entityEggInfo = (EntityList.EntityEggInfo)Goblins.entityEggs.get(Integer.valueOf(itemStack.getItemDamage()));
    ...
    {
        if (!Goblins.entityEggs.containsKey(Integer.valueOf(entityId)))
        {
            return null;
        }
        else
    ...
    {
        Iterator iterator = Goblins.entityEggs.values().iterator();
